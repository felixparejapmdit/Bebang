...
class TourGuide {
    constructor(app) {
        ...
        this.steps = [
            ...
            { title: 'Worker Management', content: "In Settings → Workers, add each worker and their rate per splint. Workers fill the Manufacturing dropdowns, and the rate drives Payroll. Renaming a worker updates all of their past records.", tab: 'settings', highlight: '#worker-management-card', setup: (app) => { app.settings.view = 'workers'; } },
            ...
            { title: 'Step 21: Settings & Backups', content: "Settings opens a dropdown in the sidebar: Account, Business Profile, Preferences, Workers, Suppliers, Expense Categories, App, Data Health and Backup. Each one is its own page with full add, edit and delete.", tab: 'settings', highlight: '#nav-btn-container-settings', setup: (app) => { app.settings.view = 'overview'; app.setSettingsMenuOpen(true); } },
            { title: 'CRITICAL: Backup', content: "Click 'Export Data' regularly to save a JSON backup of your entire database. 'Restore Data' replaces everything with a backup file.", tab: 'settings', highlight: '#backup-card', setup: (app) => { app.settings.view = 'backup'; } },
            { title: 'CRITICAL: Factory Reset', content: "The red 'Factory Reset' button deletes everything, including the item catalog. You'll be asked to type DELETE to confirm.", tab: 'settings', highlight: '#factory-reset-button', setup: (app) => { app.settings.view = 'backup'; } },
            { title: 'Clear Cache & Reload Defaults', content: "If lists look outdated after an app update, use this instead of Factory Reset. It clears this browser's local copy and reloads.", tab: 'settings', highlight: '#clear-cache-button', setup: (app) => { app.settings.view = 'backup'; } },
            { title: 'Install as an App', content: "Install Bebang BMS on your phone or computer from the 'App & Offline' card. It opens full-screen and keeps working offline.", tab: 'settings', highlight: '#app-card', setup: (app) => { app.settings.view = 'app'; } },
